...
// ─────────────────────────────────────────────────────────────────────────────
//  AppTheme  —  Dark/Light tema konfiguratsiyasi
//  Barcha widgetlar AppColorsContext.of(context) orqali color'larni oladi
// ─────────────────────────────────────────────────────────────────────────────
class AppTheme {
  // Shared (theme-dan mustaqil)
  ...
  // ── Legacy dark constants — mavjud kod bilan moslik ──────────────────────
  // ESLATMA: yangi widgetlarda AppColorsContext.of(context) ishlating!
...
// ═══════════════════════════════════════════════════════════════════════════════
//  ThemeColors  —  Runtime theme-aware color'lar
//
//  Ishlatish:
//    final c = AppColorsContext.of(context);
//    c.background, c.surface, c.textPrimary, ...
// ═══════════════════════════════════════════════════════════════════════════════
class ThemeColors {
  ...
  const ThemeColors.dark()
      : background    = AppColors.dBackground,
        surface       = AppColors.dSurface,
        surfaceLight  = AppColors.dSurfaceLight,
        textPrimary   = AppColors.dTextPrimary,
        textSecondary = AppColors.dTextSecondary,
        myMsgBg       = AppColors.dMyMsgBg,
        otherMsgBg    = AppColors.dOtherMsgBg;
  ...
  const ThemeColors.light()
      : background    = AppColors.lBackground,
        ...
        myMsgBg       = AppColors.lMyMsgBg,
        otherMsgBg    = AppColors.lOtherMsgBg;
}

// ─────────────────────────────────────────────────────────────────────────────
//  AppColorsContext.of(context)  —  Extension method color'larni olish uchun
// ─────────────────────────────────────────────────────────────────────────────
extension AppColorsContext on AppColors {
  static ThemeColors of(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    return isDark ? const ThemeColors.dark() : const ThemeColors.light();
  }
}