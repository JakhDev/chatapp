...
import 'package:chatapp/widgets/MessageBuble.dart'; // Agar fayl nomi MessageBubble bo'lsa, xatolik bermasligi uchun tekshiring
...
// Provayderga context-ni ham muvaffaqiyatli uzatdik
          ...
          Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              ListTile(
                ...
                leading: const Icon(
                    Icons.camera_alt_outlined, color: AppTheme.primary),

                title: const Text(
                    'Kamera', style: TextStyle(color: AppTheme.textPrimary)),
              ...
              ListTile(
                ...
                leading: const Icon(
                    Icons.photo_library_outlined, color: AppTheme.accent),

                title: const Text(
                    'Galereya', style: TextStyle(color: AppTheme.textPrimary)),
...
// Har safar yangi xabar kelganda avtomatik pastga tushish mantiqi
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            icon: const Icon(
                Icons.videocam_outlined, color: AppTheme.textSecondary),
          ...
          IconButton(
            ...
            icon: const Icon(
                Icons.call_outlined, color: AppTheme.textSecondary),
      ...
      body: GestureDetector(
        ...
        // Ekranni bosganda klaviatura yopiladi
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.end,
          children: [ // crossAxisAlignment pastga tekislandi
            ...
            Expanded(
              ...
              child: TextField(
                ...
                // Klaviaturada jo'natish belgisi chiqadi

                onSubmitted: (_) => onSend(),
                // Enter bosilganda ham xabar ketadi
