...
class AppSettings extends ChangeNotifier {
  ...
  String get member       => _t(uz: 'a\'zo',        ru: 'участников',  en: 'members');
  ...
  String get appNotifications => _t(uz: 'Ilova bildiriahnomalari', ru: 'Уведомления приложения', en: 'App notifications');
